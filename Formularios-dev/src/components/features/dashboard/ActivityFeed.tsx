...
import { getRecentActivityByArea } from "@/lib/actions/inspection-herra-equipos";
  ...
  const loadActivity = useCallback(async () => {
    ...
    try {
      ...
      if (isSupervisorLike) {
        ...
        result = await getRecentActivityByArea({
      ...
      if (result.success && result.data) {
        setInspections(result.data.slice(0, MAX_VISIBLE));
      } else {
