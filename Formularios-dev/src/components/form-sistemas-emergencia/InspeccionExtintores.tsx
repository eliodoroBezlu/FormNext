...
const InspeccionExtintores = ({
  ...
  // para debugging de que esta funcionando

  // useEffect(() => {
  //   console.log("Props extintores recibidos:", extintores);
  //   console.log("Tipo de extintores:", typeof extintores);
  //   console.log("Es array:", Array.isArray(extintores));
  //   console.log("Extintores procesados:", extintoresArray);
  //   console.log("Longitud del array procesado:", extintoresArray.length);

  //   if (extintoresArray && extintoresArray.length > 0) {
  //     console.log("Primer extintor:", extintoresArray[0]);
  //     console.log(
  //       "Propiedades del primer extintor:",
  //       Object.keys(extintoresArray[0])
  //     );
  //   }
