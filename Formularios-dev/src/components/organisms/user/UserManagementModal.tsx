...
//   user_info: UserInfoData; // ← Cambio de keycloak_info a user_info
//   status: {
...
//                   </Typography>
//                   <Typography><strong>Username:</strong> {userInfo.userInfo.username}</Typography>
//                   <Typography><strong>Email:</strong> {userInfo.userInfo.email || 'No configurado'}</Typography>
//                   <Box display="flex" alignItems="center" gap={1}>
//                     <Typography component="span">
...
// ✅ ACTUALIZADAS: Interfaces sin Keycloak
interface UserInfoData {
  id: string;
  username: string;
  email?: string;
